...
### v00.01.06
1. [R] Update configuration file handling:
    - [R] On start up, look for configuration in the local directory in .config/mwt-g/
    - [R] If it doesn't exist, create it in $HOME
1. [R] Ensure that testResults.xml is moved into the appropriate testruns/ after each run.
